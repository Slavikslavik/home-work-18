            ...
            fetch(`https://todo.hillel.it/todo/${note._id}/toggle`,{
                ...
                .then(result => {
                    ...
                    if(result){
                        ...
                        document.querySelector(`[data-id="${note._id}"] .note__button-done`).disabled = true;
                        document.querySelector(`[data-id="${note._id}"] .note__button--edit`).disabled = true;
                    }else{
...
// const saveData = JSON.parse(localStorage.getItem('notes'));
